...
var _libReactDataList = require('../lib/ReactDataList');

var _libReactDataList2 = _interopRequireDefault(_libReactDataList);
...
var NativeSwitch = (function (_React$Component) {
    _inherits(NativeSwitch, _React$Component);

    function NativeSwitch(props) {
        _classCallCheck(this, NativeSwitch);

        _get(Object.getPrototypeOf(NativeSwitch.prototype), 'constructor', this).call(this, props);
        this.state = {
            checked: ''
        };
    }

    _createClass(NativeSwitch, [{
        key: 'render',
        value: function render() {
            return _react2['default'].createElement(
                'div',
                { className: 'onoffswitch', onClick: this.toggleNative.bind(this) },
                _react2['default'].createElement('input', { type: 'checkbox', name: 'onoffswitch', className: 'onoffswitch-checkbox', id: 'myonoffswitch', checked: this.state.checked }),
                _react2['default'].createElement(
                    'label',
                    { className: 'onoffswitch-label' },
                    _react2['default'].createElement('div', { className: 'onoffswitch-inner' }),
                    _react2['default'].createElement('div', { className: 'onoffswitch-switch' })
                )
            );
        }
    }, {
        key: 'toggleNative',
        value: function toggleNative(event) {
        ...
        value: function render() {
            ...
            if (this.props.selectedOption != undefined) {
                selectedOption = _react2['default'].createElement(
                    ...
                    _react2['default'].createElement('img', { src: 'http://gifs.joelglovier.com/thumbs-up/thumbs-up.gif' }),
                    _react2['default'].createElement(
                        'span',
                        { className: 'advice' },
                        'Good choice!'
            ...
            if (this.props.error != undefined) error = _react2['default'].createElement(
                'div',
    ...
    _createClass(Demo, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                null,
                _react2['default'].createElement(NativeSwitch, { onChange: this.handleNativeRequest.bind(this) }),
                _react2['default'].createElement(
                    'h1',
                    { className: 'main-label' },
                    'Find your favorite fruit!'
                ),
                _react2['default'].createElement(_libReactDataList2['default'], {
                    list: 'fruit',
                    options: _fruit2['default'],
                    forcePoly: this.state.forcePoly,
                    onOptionSelected: this.onOptionSelected.bind(this) }),
                _react2['default'].createElement(MessageBox, {
                    selectedOption: this.state.selectedOption,
                    conflicted: !this.state.support && !this.state.forcePoly })
            );
        }
    }, {
        key: 'handleNativeRequest',
        value: function handleNativeRequest(native) {
            this.setState({
                forcePoly: !native,
                filter: '',
...
var ReactDataList = (function (_React$Component) {
    ...
    _createClass(ReactDataList, [{
        ...
        value: function render() {
            ...
            var layoutstyle = this.props.includeLayoutStyle ? _react2['default'].createElement('style', null, layout) : null;
            return _react2['default'].createElement('div', { className: 'react-datalist-container' }, layoutstyle, _react2['default'].createElement('input', { ref: 'theInput',
...
},{"./components/DataList":4,"./components/DataListOption":5,"react":162,"react-dom":6}],4:[function(require,module,exports){
'use strict';
...
var DataList = (function (_React$Component) {
    ...
    _createClass(DataList, [{
        ...
        value: function render() {
            ...
            if (this.props.useNative) return _react2['default'].createElement('datalist', { id: this.props.id, className: "react-datalist" }, options);
            return _react2['default'].createElement('div', { id: this.props.id, className: 'react-datalist', style: containerStyle }, options);
        }
    }]);
...
},{"./DataListOption":5,"react":162}],5:[function(require,module,exports){
'use strict';
...
var DatalistOption = (function (_React$Component) {
    ...
    _createClass(DatalistOption, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement('div', { className: classes, onClick: this.handleClick.bind(this) }, this.props.option);
        }
    }, {
        key: 'handleClick',
