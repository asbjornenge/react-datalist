...
var ReactDataList = _interopRequire(require("../lib/ReactDataList"));

var fruit = _interopRequire(require("./fruit"));
        ...
        render: {
            value: function render() {
                return React.createElement(
                    ...
                    React.createElement("input", { type: "checkbox", name: "onoffswitch", className: "onoffswitch-checkbox", id: "myonoffswitch", checked: this.state.checked }),
                    React.createElement(
                        "label",
                        { className: "onoffswitch-label" },
                        React.createElement("div", { className: "onoffswitch-inner" }),
                        React.createElement("div", { className: "onoffswitch-switch" })
                    )
                );
            }
        },
            ...
            value: function render() {
                ...
                if (this.props.selectedOption != undefined) {
                    selectedOption = React.createElement(
                        ...
                        React.createElement("img", { src: "http://gifs.joelglovier.com/excited/thumbs-up.gif" }),
                        React.createElement(
                            "span",
                            { className: "advice" },
                            "Good choice!"
                ...
                if (this.props.error != undefined) error = React.createElement(
                    "div",
        ...
        render: {
            value: function render() {
                ...
                return React.createElement(
                    "div",
                    null,
                    React.createElement(NativeSwitch, { onChange: this.handleNativeRequest.bind(this) }),
                    React.createElement(
                        "h1",
...
React.render(React.createElement(Demo, null), document.querySelectorAll("#container")[0]);

},{"../lib/ReactDataList":3,"./fruit":2,"react":160}],2:[function(require,module,exports){
"use strict";
    ...
    _createClass(ReactDataList, {
        render: {
            value: function render() {
                ...
                var layoutstyle = this.props.includeLayoutStyle ? React.createElement("style", null, layout) : null;
                return React.createElement("div", { className: "react-datalist-container" }, layoutstyle, React.createElement("input", { ref: "theInput",
...
},{"./components/DataList":4,"./components/DataListOption":5,"react":160}],4:[function(require,module,exports){
"use strict";
...
},{"./DataListOption":5,"react":160}],5:[function(require,module,exports){
"use strict";
    ...
    _createClass(DatalistOption, {
        render: {
            value: function render() {
                ...
                }return React.createElement("div", { className: classes, onClick: this.handleClick.bind(this) }, this.props.option);
            }
        },
        handleClick: {
